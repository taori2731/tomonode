...
test("keeps the 0.4.6 release workflow on the Tauri-only signing path", async () => {
  ...
  assert.match(workflow, /RELEASE_VERSION -ne "0\.4\.6"/);
  assert.match(workflow, /RELEASE_TAG -ne "v0\.4\.6"/);
