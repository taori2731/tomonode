...
test("keeps the 0.4.9 release workflow on the Tauri-only signing path", async () => {
  ...
  assert.match(workflow, /RELEASE_VERSION -ne "0\.4\.9"/);
  assert.match(workflow, /RELEASE_TAG -ne "v0\.4\.9"/);
